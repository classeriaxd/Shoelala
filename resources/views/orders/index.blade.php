               ...
               <table class="table-hover table-bordered w-100 text-center">
                    ...
                    @foreach($completedOrders as $completedOrder)
                        <tr>
                            ...
                            <td>{{$completedOrder->completed_date}}</td>
                ...
                <table class="table-hover table-bordered w-100 text-center">
                    ...
                    @foreach($cancelledOrders as $cancelledOrder)
                        <tr>
                            ...
                            <td>{{$cancelledOrder->order_date}}</td>
                            <td>{{$cancelledOrder->cancel_date ?? 'none'}}</td>
                        </tr>
                    @php $i += 1; @endphp
                    @endforeach
                    </tbody>
               ...
               <table class="table-hover table-bordered w-100 text-center">
                    ...
                    @foreach($expiredOrders as $expiredOrder)
                        <tr>
                            ...
                            <td>{{$expiredOrder->order_date}}</td>
                            <td>{{$expiredOrder->completed_date}}</td>
