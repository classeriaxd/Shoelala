...
<div class="container" style="margin-top: 100px;" id="main-container">
    <div class="row justify-content-center">
        <div class="col-md-12">
            <h3 class="display-1 text-center mt-4">Order Reports</h3>
            <a href="/home">
                <button class="btn btn-secondary col-md-12 btn-lg mb-3">Go back</button>
            </a>
        {{-- Quarter Buttons --}}
            <div class="row text-center">
                <div class="col ">
                    <form action="{{route('orderreport.show')}}" method="POST">
                        @csrf
                ...
                <div class="card">
                    ...
                    {{-- Custom Submit Button --}}
                        <div class="form-group row">
                            <div class="col">
                                <button class="btn btn-success col-md-12 btn-lg" name="custom" value="custom" type="submit">Generate Report</button>
                            </div>
                        </div>    
                    </div>
                </div>    
