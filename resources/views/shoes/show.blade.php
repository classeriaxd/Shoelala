    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            ...
            <a href="/s/{{$brand->slug}}/{{$shoe->slug}}/images/create">
                <button class="btn btn-primary col-md-12 btn-lg mb-2">Add Image</button>
            </a>
            @elserole('Admin')
            <a href="/s">
                <button class="btn btn-secondary col-md-12 btn-lg mb-2">Go back</button>
                ...
                <div class="card-header text-center">{{$shoe->name}}</div>
                    <div class="card-body">
                        @foreach($shoeImages as $shoeImage)
                                <img src="{{'/storage/'.$shoeImage->image}}" class="text-center" style="max-width:200px; max-height:200px;min-width:200px; min-height:200px;">
                        @endforeach
                        <div class="row">
                            <div class="col-md-6">
